<?php
/* 
Template Name: misc / cat archive
*/
...
<main class="page-content">
    ...
    <section class="bg-gray-lighter section-40 section-md-139" id="container_collection">
        ...
        <?php $args = array('post_type' => 'miscellaneous'); ?>
                ...
                <a href="<?php the_permalink(); ?>">
                    <div class="col-md-3 the-post-container">
                        ...
                        <div class="img-container">
                            <img src="<?php echo the_sub_field('item_image'); ?>" alt="" width="642" height="400" class="gallery-img">
